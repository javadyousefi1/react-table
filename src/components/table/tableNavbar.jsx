  ...
  return (
    <div className="mb-4 flex justify-between">
      ...
      <div className="flex items-center gap-x-2">
        <input
          type="text"
          className="focus:shadow-2xl bg-[#fff]  outline-none p-2 w-[300px] rounded-xl border border-[#ededed] hover:border-gray-400 transition-all ease-linear duration-100 cursor-pointer focus:border-mainDarkBlue"
        />
